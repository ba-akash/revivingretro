              ...
              <div className="col-md-4 mb-4 mb-md-0">
                <NavLink className="category-item" to="/shop">
                  <img
                    ...
                    alt=""
                  />
                  <strong className="category-item-title">Monuments</strong>
                </NavLink>
              </div>
              <div className="col-md-4 mb-4 mb-md-0">
                <NavLink className="category-item mb-4" to="/shop">
                  <img
                    ...
                    alt=""
                  />
                  <strong className="category-item-title">Art</strong>
                </NavLink>
                <NavLink className="category-item" to="/shop">
                  <img
                    className="img-fluid"
                    ...
                    alt=""
                  />
                  <strong className="category-item-title">Jewelry</strong>
                </NavLink>
              </div>
